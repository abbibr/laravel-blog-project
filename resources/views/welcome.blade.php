...
<body>
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="{{ asset('assets/img/index.png') }}">
							</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch">
						...
						<ul>
							<li>YangiHayot/Tashkent/Uzbekistan</li>
							<li>abbosovibrohim183@gmail.com</li>
							<li>+998 90 001-29-19</li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2022 - <a href="https://github.com/abbibr">abbibr</a>, &nbsp;  All Rights Reserved.</p>
				</div>
