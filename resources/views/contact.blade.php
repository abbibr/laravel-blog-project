			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						<h2>Have you any question? &nbsp; <a href="{{ route('sendSMS') }}">Send SMS</a></h2>
					...
					<div class="contact-form">
						...
						<form action="{{ route('send-email') }}" method="post">
							...
							<p>
								<input type="text" autocomplete="off" placeholder="Phone" name="phone" id="phone">
								<input type="text" autocomplete="off" placeholder="Subject" name="subject" id="subject">
							</p>
							<p>
